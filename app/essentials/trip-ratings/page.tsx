      ...
      <section className="relative h-[40vh] min-h-[350px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6">
          <div className="text-center max-w-4xl">
            <Link href="/essentials" className="hero-tagline uppercase tracking-widest mb-3 hover:text-orange-300 font-semibold text-sm sm:text-base">
              Essentials
            </Link>
            <h1 className="hero-heading text-4xl sm:text-5xl md:text-6xl font-bold mt-2">Trip Difficulty Ratings</h1>
          </div>
        </div>
      </section>
