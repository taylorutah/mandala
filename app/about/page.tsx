      ...
      <section className="relative h-[50vh] min-h-[400px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6">
          <div className="text-center max-w-4xl">
            <p className="hero-tagline uppercase tracking-widest mb-3 font-semibold text-sm sm:text-base">Our Culture</p>
            <h1 className="hero-heading text-4xl sm:text-5xl md:text-6xl font-bold">About Us</h1>
          </div>
        </div>
      </section>
