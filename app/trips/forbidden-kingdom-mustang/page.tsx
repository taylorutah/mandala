      ...
      <section className="relative h-[50vh] min-h-[400px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6">
          <div className="text-center text-white max-w-4xl">
            <Link href="/destinations/nepal" className="text-amber-400 uppercase tracking-widest mb-2 hover:text-orange-300 font-semibold drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">Nepal</Link>
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-2 drop-shadow-[0_4px_8px_rgba(0,0,0,0.8)]">The Forbidden Kingdom of Mustang</h1>
          </div>
        </div>
      </section>
