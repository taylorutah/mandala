      ...
      <section className="relative h-[50vh] min-h-[400px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6">
          <div className="text-center max-w-4xl">
            <Link href="/destinations/nepal" className="hero-tagline uppercase tracking-widest mb-3 hover:text-orange-300 font-semibold text-sm sm:text-base">Nepal</Link>
            <h1 className="hero-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-2">The Forbidden Kingdom of Mustang</h1>
          </div>
        </div>
      </section>
