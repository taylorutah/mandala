      ...
      <section className="relative h-[50vh] min-h-[400px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            <Link href="/destinations/india" className="text-amber-500 uppercase tracking-widest mb-2 hover:text-orange-300">India</Link>
            <h1 className="text-4xl md:text-6xl font-bold mt-2">Ladakh's Markha Valley Trek</h1>
          </div>
        </div>
      </section>
